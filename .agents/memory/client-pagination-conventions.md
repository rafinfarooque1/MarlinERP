...
- Totals, footers, and CSV exports must read the FULL filtered set, never the page slice. (Known exception: Quotations CSV is page-scoped by long-standing design.)

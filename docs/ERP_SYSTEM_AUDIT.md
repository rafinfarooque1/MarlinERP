...
**Accounts:** Chart of Accounts · Ledger Statement · Cash & Bank · Vouchers · Journal · Contra · Credit/Debit Notes · Day Book · Cash Book · Bank Book · Trial Balance · P&L · Balance Sheet · Month Wise columns (a toggle on Chart of Accounts folds per-month columns into the BS+P&L hierarchy; ONE aggregated `/accounts/financial-statements/monthly` call — P&L cells are month activity, BS cells are as-at month end) · GST Summary · GST Returns (GSTR-1/3B/HSN) · Reconciliation · Financial Reports
